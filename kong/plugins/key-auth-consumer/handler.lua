...
local function set_consumer(consumer, credential)
  ...
  if string.match(consumer, "/") or string.match(consumer,"#") then
    print ("/ or # is not allowed in consumer name")
    --exit or rewrite consumer--or response entity, rt
    return nil, { status = 400, message = "Bad Request" }
else
